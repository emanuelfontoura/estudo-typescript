...
fruits = fruits.map(function (fruit) { return "Fruta: ".concat(fruit); }); // se quiser alterar algum item ou todos os itens, terá de usar o método MAP
console.log(fruits);
